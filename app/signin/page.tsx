    ...
    <div className="flex flex-col justify-center items-center pt-16 w-full">
      <div className="bg-white shadow-lg flex flex-col space-y-12 items-center px-8 py-8 pb-12 max-w-[428px]">
        <div className=" flex flex-col space-y-4 w-full">
          ...
          <Text>Sign in to enhance your resume and showcase your coding journey.</Text>
        </div>
        <div className="flex flex-col space-y-8 w-full">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <Link href={'/signup'}>
              <Text className="underline text-sm text-right ml-1">Don't have an account?</Text>
            </Link>
          </div>
        </div>
        <Alert
        ...
        >
          We highly recommend signing in with{' '}
